...
export default function RootLayout({
  ...
  const categories = [
    { name: "Développement Web", link: "#" },
    { name: "Intelligence Artificielle", link: "#" },
    { name: "Marketing Digital", link: "#" },
    { name: "Business & Management", link: "#" },
    { name: "Design & Créativité", link: "#" },
  ];
  const pathname = usePathname();
  const pagesSansLayout = ["/student/login", "/student/register" , "/student/courses", "/student/courses/[id]"];
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <div className="relative">
                  <Link
                    ...
                    className="flex items-center text-gray-600 hover:text-amber-600 transition-colors duration-200 focus:outline-none"
                  >
            ...
            <div className="px-4 pt-4 pb-6 space-y-3">
              ...
              <div className="border border-gray-100 rounded-lg overflow-hidden">
                <button
                  ...
                  className="flex items-center justify-between w-full px-4 py-3 bg-gray-50 hover:bg-gray-100 transition-colors duration-200"
                >
                  <Link
                    href={"/student/courses"}
                    className="flex items-center text-gray-600 hover:text-amber-600 transition-colors duration-200 focus:outline-none"
